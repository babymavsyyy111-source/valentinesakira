...
const gifs = [
  "../cat-heart.gif",
  "../https://knowyourmeme.com/photos/2738959-mr-fresh-side-eye-cat",
  "../3shocked-1.gif",
  "../4.crying.gif",
  "../5.crying.gif",
  "../idc.gif"
...
no.addEventListener("click", () => {
  if (count == 2) {
    gif.src = "../https://knowyourmeme.com/photos/2738959-mr-fresh-side-eye-cat";// gif credit: https://knowyourmeme.com/photos/2738959-mr-fresh-side-eye-cat
...
yes.addEventListener("click", () => {
  ...
  yes.innerHTML = '<a href="https://www.facebook.com/lexuzz/">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
